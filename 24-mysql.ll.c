...
define void @myExit() #0 !dbg !58 {
  ...
  %2 = call i32 @state(), !dbg !60
  %3 = icmp eq i32 %2, 2, !dbg !62
  br i1 %3, label %4, label %6, !dbg !63

; <label>:4:                                      ; preds = %0
  store i32 0, i32* %1, align 4, !dbg !64
  %5 = load i32, i32* %1, align 4, !dbg !64
  store atomic i32 %5, i32* @m_lock_word seq_cst, align 4, !dbg !64
  br label %11, !dbg !66

; <label>:6:                                      ; preds = %0
  %7 = call i32 @unlock(), !dbg !67
  %8 = icmp eq i32 %7, 1, !dbg !70
...
!64 = !DILocation(line: 65, column: 9, scope: !65)
